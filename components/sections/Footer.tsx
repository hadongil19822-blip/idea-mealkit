...
export const Footer = () => {
    return (
        <footer className="py-20 bg-slate-950/80 backdrop-blur-3xl border-t border-slate-800/80 relative z-10">
            <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-10">
                <div className="flex items-center gap-3 opacity-80">
                    <Logo className="w-8 h-8 grayscale" />
                    <div className="flex flex-col">
                        <span className="font-bold text-white tracking-widest leading-tight">아이디어 밀키트</span>
